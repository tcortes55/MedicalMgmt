...
namespace MedicalMgmt.Controllers.Business
{
    public class PhysiciansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,Expertise,GraduationUni,GraduationYear")] Physician physician)
        {
            ...
            ViewBag.UserID = new SelectList(db.Users, "ID", "Username", physician.UserID);
            return View(physician);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,Expertise,GraduationUni,GraduationYear")] Physician physician)
        {
            if (ModelState.IsValid)
            {
